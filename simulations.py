...
class SystemSimulator:
    ...
    def __init__(self, df, trace_length=100, estimator=BernoulliEstimator, ood_test_shift=ENDOCV, ood_val_shift=CVCCLINIC, **kwargs):
        ...
        self.detector_tree = DetectorEventTree(dsd_tpr, dsd_tnr, ind_ndsd_acc, ind_dsd_acc, ood_ndsd_acc, ood_dsd_acc, estimator=estimator)
        self.base_tree = BaseEventTree(dsd_tpr=dsd_tpr, dsd_tnr=dsd_tnr, ood_acc = self.ood_val_acc, ind_acc=self.ind_val_acc, estimator=estimator)
